...
void Log(const std::string& msg) {
    std::ofstream f("C:\\Users\\rafal\\Desktop\\legoclickerC\\bridge_debug.log", std::ios_base::app);
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD reason, LPVOID lpReserved) {
    if (reason == DLL_PROCESS_ATTACH) {
        ...
        std::ofstream f("C:\\Users\\rafal\\Desktop\\legoclickerC\\bridge_debug.log", std::ios_base::trunc);
